...
A powerful, self-hosted URL shortening platform with comprehensive analytics. Built with Laravel, Livewire, and modern web technologies.

## ✨ Features

### 🔗 URL Management
- **Smart URL Shortening** - Convert long URLs to memorable short codes
- **Custom Short Codes** - Create branded, custom short URLs
- **Automatic Metadata Fetching** - Extract titles, descriptions, and favicons
...
- **Geographic Analytics** - Country-based visitor insights
- **Device & Browser Tracking** - Detailed user agent analysis
...
- **Real-time Updates** - Live data updates via Livewire
...
- **Livewire Team** - For real-time UI capabilities
